...
const Hero = () => {
  return (
    <div className="w-full h-screen grid grid-cols-12 gap-12 bg-pink-200 px-24 items-center md:w-32 lg:w-full">
      ...
      >
        <svg
          className="h-48 w-48 absolute top-32 right-36"
          viewBox="0 0 200 200"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            fill="#F2F4F8"
            d="M35.2,-47C45,-33.8,51.7,-22.1,52.9,-10.1C54.1,1.9,49.9,14.2,45.1,29.3C40.3,44.4,34.8,62.4,22.2,71.7C9.6,80.9,-10.1,81.4,-29.3,76.3C-48.5,71.1,-67.1,60.3,-77.6,43.9C-88.1,27.5,-90.5,5.6,-86.7,-15.2C-82.9,-35.9,-72.9,-55.4,-57.4,-67.5C-41.9,-79.6,-21,-84.3,-4.1,-79.4C12.8,-74.5,25.5,-60.1,35.2,-47Z"
        ...
        {/* TODO: Once we have more games, uncomment & link to Games page */}
