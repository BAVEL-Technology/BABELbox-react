  ...
  return (
    <div className="w-full h-screen grid grid-cols-12 gap-12 bg-pink-200 px-24 items-center">
      ...
      <div className={`text-babelPink-500 col-span-7 font-poppins items-center`}>
        <svg className="h-48 w-48 absolute top-32 right-36" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="space-y-4 relative">
          <p className="text-4xl font-bold mb-24 text-babelPink-500 p-1 rounded-md leading-normal">
            <span className="ul-bg">BABELBOX</span>
             &nbsp;is a collection of awesome games that work in&nbsp;<span className="ul-bg">real time</span> with you and your crew.
            Play games with your&nbsp;<span className="ul-bg">family, friends and teams</span> whether you are in the same room,
