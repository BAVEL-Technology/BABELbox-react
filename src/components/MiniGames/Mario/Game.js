...
export default class Game extends Component {
  constructor(props) {
    ...
    skyImage.src = './images/minigames/mario/cloud.png';
    groundImage.src = './images/minigames/mario/ground.png';
    playerImage.src = './images/minigames/mario/mario.png.tiff';
    playerLeftImage.src = './images/minigames/mario/mario_left.png.tiff';
    playerRightImage.src = './images/minigames/mario/mario_right.png.tiff';
    playerDieImage.src = './images/minigames/mario/mario_dead.png';
    obstacleImage.src = './images/minigames/mario/obstacle.png';
  ...
  __draw() {
    ...
    ctx.save();
    console.log(this.options.skyImage);
    ...
    const scoreText = (this.status === STATUS.OVER ? 'GAME OVER  ' : '') + Math.floor(this.score);
    ...
    for (let i = 0; i < this.obstacles.length; ++i) {
      if (this.currentDistance >= this.obstacles[i].distance) {
        const offset = width - (this.currentDistance - this.obstacles[i].distance + groundSpeed);
        if (offset > 0) {
    ...
    const firstOffset = width - (this.currentDistance - this.obstacles[0].distance + groundSpeed);
