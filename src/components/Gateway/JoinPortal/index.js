...
const JoinPortal = (props) => {
  ...
  return (
    <>
      <div
        className={`bg-${props.color} w-2/3 flex flex-col text-gray-100 p-4 md:p-8 rounded-xl tracking-widest my-8 cursor-pointer`}
      ...
      >
        ...
        <button
          ...
          onClick={() => {
            join("aegis-craic", "ChristianButFromCode");
          }}
