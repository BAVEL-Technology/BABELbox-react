...
const Footer = () => {
  return (
    <footer className="w-full flex items-center justify-between bg-blue-300 py-12 mt-8">
      <div className="flex flex-col text-sm lg:px-12 md:px-12 px-4 lg:w-3/12 md:w-5/12 w-8/12">
        ...
        <br/>
        <p className="text-blue-500 font-semibold">For more information about our code, check out our <a href="https://github.com/https-github-com-steversonTong/BabelBox" target="_blank"><strong>GitHub</strong></a>.</p>
        <br/>
