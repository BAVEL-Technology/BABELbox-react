      ...
      >
        ...
        >
          ...
          <HowToPlayCard
            color="pink-600"
            type="Waiting Phase:"
            rule="See all players, scores, and change your name. Host has the ability to kick players or change the host. Host is also the person who will start the round."
          />
