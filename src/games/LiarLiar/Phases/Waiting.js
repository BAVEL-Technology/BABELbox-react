    ...
    <div className="w-full">
      ...
      <div className="flex justify-around w-full items-center">
        ...
        (<div className="flex flex-col items-center justify-center space-y-2">
          <p style={{ fontFamily: "Sniglet" }} className={`bg-red-500 text-3xl px-4 py-2 flex items-center justify-center lg:text-3xl md:text-3xl text-gray-100 font-bold h-16 lg:h-16 md:h-16 w-16 lg:w-16 md:w-16 rounded-full bg-red-500`}>{gameState.rounds.length}</p>
          <p style={{ fontFamily: "Sniglet" }} className={`font-bold text-white font-semibold text-xl tracking-wide lg:text-xl md:text-xl`}
          >ROUND</p>
        </div>) : null }
        ...
        <div className="flex flex-col items-center justify-center space-y-2">
          {/* Settings Cog SVG */}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-16 w-16"><path class="text-gray-400" fill="currentColor" d="M6.8 3.45c.87-.52 1.82-.92 2.83-1.17a2.5 2.5 0 0 0 4.74 0c1.01.25 1.96.65 2.82 1.17a2.5 2.5 0 0 0 3.36 3.36c.52.86.92 1.8 1.17 2.82a2.5 2.5 0 0 0 0 4.74c-.25 1.01-.65 1.96-1.17 2.82a2.5 2.5 0 0 0-3.36 3.36c-.86.52-1.8.92-2.82 1.17a2.5 2.5 0 0 0-4.74 0c-1.01-.25-1.96-.65-2.82-1.17a2.5 2.5 0 0 0-3.36-3.36 9.94 9.94 0 0 1-1.17-2.82 2.5 2.5 0 0 0 0-4.74c.25-1.01.65-1.96 1.17-2.82a2.5 2.5 0 0 0 3.36-3.36zM12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"/><circle cx="12" cy="12" r="2" fill="currentColor" class="text-gray-500"/></svg>
          {/* Settings text. */}
          <p
